...
public class SuperTextView extends AppCompatTextView {
    ...
    private OnAminListener mOnAminListener;

    public void setOnAminListener(OnAminListener mAminListener) {
        this.mOnAminListener = mAminListener;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mOnAminListener.onDrawAnim(this, canvas,currentRate);
        super.onDraw(canvas);
...
//    stopAnim();
    ...
    private void setAnimation(float startLocation, float endLocation, int animationLength) {
        ...
        processAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                currentRate = (float) animation.getAnimatedValue();
                currentLocation = currentRate * width;
                if (mOnAminListener != null) {
                    mOnAminListener.onAnimationUpdate(SuperTextView.this, currentRate);
                }
                invalidate();
     ...
     * 动画监听类
     */
    public static abstract class OnAminListener {
        /**
         * 绘制的时候的回调，通常可以在这里绘制动画
         * @param v
         * @param canvas
         * @param rate
         */
        protected abstract void onDrawAnim(SuperTextView v, Canvas canvas, float rate);

        /**
         * 动画参数改变过程的回调，通常可以在这里处理进行逻辑判断，或者改变比率，影响动画
         * @param v
         * @param rate
         */
        protected abstract void onAnimationUpdate(SuperTextView v, float rate);
    }
