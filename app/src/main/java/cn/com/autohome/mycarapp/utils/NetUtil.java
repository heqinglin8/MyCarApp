package cn.com.autohome.mycarapp.utils;

import android.content.Context;
import android.net.ConnectivityManager;
import android.net.NetworkInfo;
import android.telephony.TelephonyManager;
import cn.com.autohome.mycarapp.BaseApplication;
...
public class NetUtil {
	...
	public static boolean CheckNetState() {
		android.net.ConnectivityManager cManager = (android.net.ConnectivityManager) BaseApplication
